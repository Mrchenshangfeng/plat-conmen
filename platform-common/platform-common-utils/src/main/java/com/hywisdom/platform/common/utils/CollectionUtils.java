...
public class CollectionUtils {
    ...
    /**
     * @Method cloneEntityList
     * @Description:  实体类list克隆
     * @param bentitys
     ...
     * @Date: 2018/11/9
    **/
    public static <T> List<T> cloneEntityList(List<T> bentitys) {
        List<T> pPers = new ArrayList<T>();
        for (T p : bentitys) {
            try {
                pPers.add((T) BeanUtils.cloneBean(p));
